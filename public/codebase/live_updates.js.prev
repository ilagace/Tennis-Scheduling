...
if (typeof(scheduler) !== "undefined") {
	scheduler.item = function(id) {
		...
		data.start_date = scheduler.date.date_to_str(scheduler.config.api_date, true)(event.start_date);
		data.end_date = scheduler.date.date_to_str(scheduler.config.api_date, true)(event.end_date);
		return data;
	};
